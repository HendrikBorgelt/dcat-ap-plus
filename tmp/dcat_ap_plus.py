...
# Generation date: 2026-03-01T16:00:39
# Schema: dcat-ap-plus
#
...
version = "0.1.0rc3.post61.dev0+c55f29e"
...
class IdentifierNotation(extended_str):
    pass
...
class Activity(YAMLRoot):
    ...
    other_identifier: Optional[Union[Union[str, IdentifierNotation], list[Union[str, IdentifierNotation]]]] = empty_list()
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        self.other_identifier = [v if isinstance(v, IdentifierNotation) else IdentifierNotation(v) for v in self.other_identifier]
...
class Identifier(SupportiveEntity):
    ...
    notation: Union[str, IdentifierNotation] = None
    title: Optional[str] = None
    description: Optional[str] = None
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        if not isinstance(self.notation, IdentifierNotation):
            self.notation = IdentifierNotation(self.notation)
...
slots.notation = Slot(uri=SKOS.notation, name="notation", curie=SKOS.curie('notation'),
                   model_uri=DCATAPPLUS.notation, domain=None, range=URIRef)
...
slots.Activity_other_identifier = Slot(uri=ADMS.identifier, name="Activity_other_identifier", curie=ADMS.curie('identifier'),
                   model_uri=DCATAPPLUS.Activity_other_identifier, domain=Activity, range=Optional[Union[Union[str, IdentifierNotation], list[Union[str, IdentifierNotation]]]])
...
slots.AgenticEntity_other_identifier = Slot(uri=ADMS.identifier, name="AgenticEntity_other_identifier", curie=ADMS.curie('identifier'),
                   model_uri=DCATAPPLUS.AgenticEntity_other_identifier, domain=AgenticEntity, range=Optional[Union[Union[str, IdentifierNotation], list[Union[str, IdentifierNotation]]]])
...
slots.Dataset_other_identifier = Slot(uri=ADMS.identifier, name="Dataset_other_identifier", curie=ADMS.curie('identifier'),
                   model_uri=DCATAPPLUS.Dataset_other_identifier, domain=Dataset, range=Optional[Union[Union[str, IdentifierNotation], list[Union[str, IdentifierNotation]]]])
...
slots.Device_other_identifier = Slot(uri=ADMS.identifier, name="Device_other_identifier", curie=ADMS.curie('identifier'),
                   model_uri=DCATAPPLUS.Device_other_identifier, domain=Device, range=Optional[Union[Union[str, IdentifierNotation], list[Union[str, IdentifierNotation]]]])
...
slots.Entity_other_identifier = Slot(uri=ADMS.identifier, name="Entity_other_identifier", curie=ADMS.curie('identifier'),
                   model_uri=DCATAPPLUS.Entity_other_identifier, domain=Entity, range=Optional[Union[Union[str, IdentifierNotation], list[Union[str, IdentifierNotation]]]])
...
slots.EvaluatedActivity_other_identifier = Slot(uri=ADMS.identifier, name="EvaluatedActivity_other_identifier", curie=ADMS.curie('identifier'),
                   model_uri=DCATAPPLUS.EvaluatedActivity_other_identifier, domain=EvaluatedActivity, range=Optional[Union[Union[str, IdentifierNotation], list[Union[str, IdentifierNotation]]]])
...
slots.EvaluatedEntity_other_identifier = Slot(uri=ADMS.identifier, name="EvaluatedEntity_other_identifier", curie=ADMS.curie('identifier'),
                   model_uri=DCATAPPLUS.EvaluatedEntity_other_identifier, domain=EvaluatedEntity, range=Optional[Union[Union[str, IdentifierNotation], list[Union[str, IdentifierNotation]]]])

slots.Identifier_notation = Slot(uri=SKOS.notation, name="Identifier_notation", curie=SKOS.curie('notation'),
                   model_uri=DCATAPPLUS.Identifier_notation, domain=Identifier, range=Union[str, IdentifierNotation])
...
slots.Software_other_identifier = Slot(uri=ADMS.identifier, name="Software_other_identifier", curie=ADMS.curie('identifier'),
                   model_uri=DCATAPPLUS.Software_other_identifier, domain=Software, range=Optional[Union[Union[str, IdentifierNotation], list[Union[str, IdentifierNotation]]]])
